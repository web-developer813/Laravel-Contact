@extends('admin.layout')
	@section('body')
		<h3 class="page-title">Add Project Type Management</h3>
			<!-- page layout -->
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{URL::route('admin.temp.create')}}">Add Project Type</a>
					</li>
				</ul>
			</div>
			<div class="row">
							...
							<form  class="form-horizontal" id="addCategoryFiledForm" method="POST" action="{{URL::route('admin.type.store')}}" enctype="multipart/form-data">
							    ...
							    <div class="form-body">
                                    <div class="form-group" id="countryname">
                                         <label class="col-md-3 col-sm-3 col-xs-12 control-label">Project Type</label>
