@extends('admin.layout')
	@section('body')
		<h3 class="page-title">Edit Note Type Management</h3>
			<!-- page layout -->
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{URL::route('admin.noteType.edit',$noteType->id)}}">Edit Note Type</a>
					</li>
				</ul>
			</div>
			<div class="row">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<form  class="form-horizontal" id="addCategoryFiledForm" method="POST" action="{{URL::route('admin.noteType.store')}}" enctype="multipart/form-data">
							    <input type="hidden" name="noteType_id" value="{{ $noteType->id }}">
							    {!! Form::token()!!}
							    <div class="form-body">
                                     @foreach ([
                                        'notesType' => 'Note  Type',
                                            ...
                                            <div class="form-group" id="countryname">
                                                 <label class="col-md-3 col-sm-3 col-xs-12 control-label">{!! Form::label($key, $value) !!}</label>
                                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                                      {!! Form::text($key, $noteType->$key, ['class' => 'form-control','placeholder'=>$value]) !!}
                                                 </div>
                                            </div>
                                         @endif
                                      @endforeach
