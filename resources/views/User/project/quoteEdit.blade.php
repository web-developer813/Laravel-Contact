                            ...
                            <div class="panel-body" id="panelBodyDiv">
                                @foreach($quote as $key=>$value)
                                    <div class="row margin-bottom-5">
                                          ...
                                          <div class="col-md-4">
                                                <p><a href="{{URL::route('user.project.deleteQuote',array($value->id,'editQuote'))}}" style="color:red">Delete</a></p>
                                          </div>
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{URL::Route('user.project.storeQuote')}}" method="post" id="quoteDiv">
                                ...
                                <input type="hidden" name="quoteListId" value="{{$quoteItem->id}}">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <input type="button" class="btn-u btn-u-blue" value="Edit Quote" onclick="onSaveQuote()">
