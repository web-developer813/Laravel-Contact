@extends('admin.layout')
	@section('body')
		<h3 class="page-title">Add Note Status Management</h3>
			<!-- page layout -->
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{URL::route('admin.noteStatus.create')}}">Add Note Status</a>
					</li>
				</ul>
			</div>
			<div class="row">
                                    ...
                                    <div class="form-group" id="countryname">
                                         <label class="col-md-3 col-sm-3 col-xs-12 control-label">Note Status</label>
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" name="notesStatus" class="form-control" placeholder="Note Status">
                                         </div>
                                    </div>
							    </div>
