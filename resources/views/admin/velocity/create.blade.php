@extends('admin.layout')
	@section('body')
		<h3 class="page-title">Add Velocity Unit Management</h3>
			<!-- page layout -->
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{URL::route('admin.velocity.create')}}">Add Velocity Unit</a>
					</li>
				</ul>
			</div>
			<div class="row">
							...
							<form  class="form-horizontal" id="addCategoryFiledForm" method="POST" action="{{URL::route('admin.velocity.store')}}" enctype="multipart/form-data">
							    ...
							    <div class="form-body">
                                    <div class="form-group" id="countryname">
                                         <label class="col-md-3 col-sm-3 col-xs-12 control-label">Velocity Unit</label>
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                             <input type="text" name="unit" class="form-control" placeholder="Velocity Unit">
                                         </div>
                                    </div>
							    </div>
